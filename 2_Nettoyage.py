...
df_oms = pd.read_csv('data/oms/dataset-absolute-numbers-mort-both-sexes-in-2022-continents (1).csv')
...
df_pubmed_enriched = df_pubmed_enriched[['Maladie', 'Nb_Publications_2024', 'Mortality']]
...
df_pubmed_enriched['Publications_per_1000_deaths'] = (
    df_pubmed_enriched['Publications_2024'] / df_pubmed_enriched['Mortality_2022'] * 1000
).round(2)
